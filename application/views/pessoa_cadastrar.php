<div class="row">
  <div class="col-md-8 col-md-offset-2">
    <div class="text-center">
      <img style="width:200px;"src="<?php echo base_url('assets/img/trello.png'); ?>" alt="Trello Api" />
    </div>
    <?php
      $atributos = array('class' => 'form-cadastro', 'id' => 'form-cadastro');
      echo form_open('pessoa/cadastrar', $atributos);
        echo form_fieldset('<span class="glyphicon glyphicon-user"></span> Cadastro via api');
    ...
    ?>
    <?php
      $atributos = array('class' => 'form-cadastro', 'id' => 'form-cadastro2');
      echo form_open('index.php/pessoa/cadastrarCard', $atributos);
        echo form_fieldset('<span class="glyphicon glyphicon-user"></span> Cadastrar Card');
        if(validation_errors()){
          echo '<div role="alert" class="alert alert-danger alert-dismissible fade in">';
          echo '<button aria-label="Close" data-dismiss="alert" class="close" type="button"><span aria-hidden="true">×</span></button>';
          echo '<h4 id="erro_titulo">Ops! Verifique o seu formulário!</h4>';
        ...
        echo '<div class="row">';
          echo '<div class="form-group col-sm-6"">';
            ...
            echo form_input(array('name' => 'titulo', 'type' => 'text', 'placeholder' => 'Digite seu titulo', 'class' => 'form-control', 'value' => set_value('titulo')));
          echo '</div>';
          echo '</div>';
          echo "<div class='row'>";
          echo '<div class="form-group col-md-12">';
            echo form_label('* Descricao', 'descricao');
            echo form_textarea(array('name' => 'descricao', 'type' => 'text', 'placeholder' => 'Digite sua descricao', 'class' => 'form-control', 'value' => set_value('descricao')));
          echo '</div>';
            echo "</div>";
